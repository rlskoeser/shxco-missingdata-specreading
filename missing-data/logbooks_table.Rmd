...
knit_root_dir: "/Volumes/Samsung_T5/shxco-missingdata-specreading/"
encoding: UTF-8
---
...
skipped_periods <- read_csv_safe("data/skipped_logbook_periods.csv")
...
updated_skipped_periods <- read_csv_safe("data/updated_skipped_logbook_periods.csv")
...
gtsave(gap_table, glue::glue("gaps.png"))
